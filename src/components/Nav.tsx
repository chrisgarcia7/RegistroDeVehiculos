...
export default function Nav({ abrir, setAbrir }: Props) {
  ...
  return (
    <div className="card flex justify-content-center">
      <Sidebar
        visible={visible}
        onHide={() => setAbrir(!abrir)}
        content={({ closeIconRef, hide }) => (
          <div className="h-full flex flex-column surface-section">
            <div
              id="app-sidebar-2"
              ...
              <div className="flex flex-column h-full">
                ...
                <div className="mt-auto">
                  ...
                  <a className="m-3 flex align-items-center cursor-pointer p-3 gap-2 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                    <Avatar
                      image="https://thumbs.dreamstime.com/b/usuario-de-medios-sociales-vectorial-icono-perfil-avatar-predeterminado-retrato-176256935.jpg"
                      shape="circle"
                    />
                    <span className="font-bold">Christian García</span>
                  </a>
                </div>
              </div>
            </div>
